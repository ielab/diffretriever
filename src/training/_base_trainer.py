...
#         tevatron/src/tevatron/retriever/trainer.py
#
# Modifications: rewrote the `from .modeling import EncoderModel` import
# to the local vendored module (`._base_encoder`). See the NOTICE file
