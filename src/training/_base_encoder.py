# =====================================================================
# Vendored from Tevatron (Apache License 2.0).
# Source: https://github.com/texttron/tevatron
#         tevatron/src/tevatron/retriever/modeling/encoder.py
#
# Modifications: rewrote the `tevatron.retriever.arguments` import to
# the local vendored module (`._base_arguments`). See the NOTICE file
...
from ._base_arguments import ModelArguments, TevatronTrainingArguments as TrainingArguments
